...
@section('content')
    ...
    @endif
        ...
        <script>
            window.addEventListener('load', function() {
                setTimeout(function (){
                    document.getElementById('box-loading').classList.add('box-animatin');
                    document.getElementById('box-loading').classList.add('d-none');
                    document.getElementById('box-form').classList.add('box-animatin')
                    document.getElementById('box-form').classList.remove('d-none')
                }, 3000);
            });
        </script>
    <div class="nk-content">
        <div class="container-fluid">
            <div class="nk-content-inner" style="margin-top: 100px">
                <div class="nk-content-body">
                    <div class="wide-md mx-auto">
                        <div class="nk-block-head nk-block-head-lg wide-sm">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title fw-normal">ایجاد پروژه</h2>
                                <div class="nk-block-des">
                                    <p class="lead">اطلاعات پروژه جدید را وارد کنید</p>
                                </div>
                            </div>
                        </div>
                        <!-- .nk-block-head -->
                        <div class="nk-block box-animatin" id="box-loading">
                        ...
                        <!-- .nk-block -->
                        <!-- .nk-block-head -->
                        <div class="nk-block nk-block-lg d-none" id="box-form">
                            <div class="card card-bordered">
                                <form class="nk-stepper stepper-init is-alter nk-stepper-s1" method="POST" action="{{ route('a_Create_Projects_Post') }}" id="stepper-create-project" enctype="multipart/form-data">
                                    @csrf
                                    @method('POST')
                                    <label for="user_id_create"></label>
                                    <input type="text" class="form-control" id="user_id_create" value="{{ Auth::user()->id }}" name="user_id_create" hidden>
                                            ...
                                            <div class="card-inner">
                                                <ul class="nk-stepper-nav nk-stepper-nav-s1 stepper-nav is-vr">
                                                    <li>
                                                        <div class="step-item">
                                                            <div class="step-text">
                                                                <div class="lead-text">مقدمه</div>
                                                                <div class="sub-text">پروژه خود را نامگذاری کنید</div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="step-item">
                                                            <div class="step-text">
                                                                <div class="lead-text">اطلاعات مشتری / کارفرما</div>
                                                                <div class="sub-text">کارفرما پروژه را تعریف کنید</div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="step-item">
                                                            <div class="step-text">
                                                                <div class="lead-text">اطلاعات بیشتر</div>
                                                                <div class="sub-text">به دنبال اطلاعات بیشتر</div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="step-item">
                                                            <div class="step-text">
                                                                <div class="lead-text">تکمیل شد</div>
                                                                <div class="sub-text">بررسی و ارسال</div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
                                                ...
                                                <div class="nk-stepper-content">
                                                    <div class="nk-stepper-steps stepper-steps">
                                                        <div class="nk-stepper-step">
                                                            <h5 class="title mb-3">جزئیات پروژه جدید</h5>
                                                            <div class="row g-3">
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="title">نام پروژه</label>
                                                                        <div class="form-control-wrap">
                                                                            <input type="text" class="form-control" id="title" name="title" placeholder="عنوان" required data-msg="نام پروژه را وارد کنید" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="dec">توضیحات پروژه</label>
                                                                        <div class="form-control-wrap">
                                                                             <textarea class="form-control form-control-sm" id="dec" name="dec" placeholder="توضیحات پروژه را بنویسید" required data-msg="توضیحات پروژه را وارد کنید" ></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-control-wrap">
                                                                            <select class="form-select js-select2 select2-hidden-accessible" id="active" tabindex="-1" aria-hidden="true" name="active" required>
                                                        ...
                                                        <div class="nk-stepper-step">
                                                            <h5 class="title mb-3">اطلاعات کارفرما</h5>
                                                            <div class="row g-3">
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label class="form-label" for="customer">نام کارفرما</label>
                                                                        <div class="form-control-wrap">
                                                                            <input type="text" maxlength="100" class="form-control" id="customer" name="customer" placeholder="نام کارفرما" data-msg="نام کارقرما را وارد کنید" required />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="nk-stepper-step">
                                                            <h5 class="title mb-3">اطلاعات بیشتر</h5>
                                                            <div class="row g-3">
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-control-wrap">
                                                                            <div class="form-file">
                                                                                <input type="file" class="form-file-input" id="img" name="img">
                                                                                <label class="form-file-label" for="img">انتخاب فایل</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="nk-stepper-step text-center">
                                                            <h5 class="title mb-2">با موفقیت دریافت شد!</h5>
                                                            <p class="text-soft">پروژه شما در انتظار ثبت می باشد</p>
                                                            <div class="gfx w-50 mx-auto">
                                                                <svg width="100%" viewBox="0 0 228 157" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#clip0_720_229)">
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#F57D77"
                                                                        />
                                                                        <path d="M98.5676 12.841C98.2961 12.9273 98.148 12.8533 98.074 12.6192C98.3578 12.5329 98.3578 12.5329 98.5676 12.841Z" fill="#F57D77" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#F57D77"
                                                                        />
                                                                        <path d="M11.1316 15.5891C11.255 15.4905 11.3414 15.4289 11.4771 15.3303C11.3784 15.5768 11.3784 15.5768 11.1316 15.5891Z" fill="#F57D77" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#F57D77"
                                                                        />
                                                                        <path d="M100.875 13.1492C100.777 13.2847 100.715 13.371 100.628 13.4942C100.641 13.2478 100.641 13.2478 100.875 13.1492Z" fill="#F57D77" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#F57D77"
                                                                        />
                                                                        <path d="M95.0626 11.3499C95.0009 11.2267 94.9639 11.1527 94.9392 11.1034C95.0873 11.0665 95.0873 11.0665 95.0626 11.3499Z" fill="#F57D77" />
                                                                        <path
                                                                            ...
                                                                            fill="#F57D77"
                                                                        />
                                                                        <path d="M94.0383 12.2865C93.9766 12.2495 93.9149 12.2126 93.7915 12.1386C94.0754 12.114 94.0754 12.114 94.0383 12.2865Z" fill="#F57D77" />
                                                                        <path d="M5.75099 14.2212C5.80036 14.3075 5.84972 14.3814 5.89909 14.4677C5.75099 14.4923 5.61524 14.517 5.75099 14.2212Z" fill="#F57D77" />
                                                                        <path
                                                                            ...
                                                                            fill="#F57D77"
                                                                        />
                                                                        <path d="M99.9499 12.3728C99.8511 12.4221 99.7771 12.459 99.6907 12.496C99.6784 12.3974 99.6167 12.2495 99.9499 12.3728Z" fill="#F57D77" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#F57D77"
                                                                        />
                                                                        <path d="M96.4819 11.1772C96.4943 11.0047 96.6177 11.0786 96.7164 11.0663C96.7041 11.2265 96.5683 11.1526 96.4819 11.1772Z" fill="#F57D77" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#564C93"
                                                                        />
                                                                        <path d="M101.196 135.496C100.875 135.767 100.875 135.767 100.592 135.52C100.814 135.163 100.863 135.151 101.196 135.496Z" fill="#564C93" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#564C93"
                                                                        />
                                                                        <path d="M76.3292 147.918C76.502 148.14 76.502 148.14 76.4403 148.485C76.07 148.287 76.0577 148.25 76.3292 147.918Z" fill="#564C93" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#564C93"
                                                                        />
                                                                        <path d="M101.937 138.65C101.998 138.946 101.826 138.971 101.677 139.069C101.566 138.786 101.714 138.724 101.937 138.65Z" fill="#564C93" />
                                                                        <path
                                                                            ...
                                                                            fill="#564C93"
                                                                        />
                                                                        <path d="M95.2479 146.463C95.1862 146.18 95.359 146.143 95.5194 146.044C95.6181 146.328 95.4701 146.389 95.2479 146.463Z" fill="#564C93" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#564C93"
                                                                        />
                                                                        <path d="M94.0015 142.508C94.0385 142.446 94.0755 142.384 94.1496 142.261C94.1742 142.545 94.1742 142.545 94.0015 142.508Z" fill="#564C93" />
                                                                        <path d="M95.3959 140.647C95.3465 140.561 95.2972 140.487 95.2478 140.4C95.3836 140.376 95.5193 140.351 95.3959 140.647Z" fill="#564C93" />
                                                                        <path
                                                                        ...
                                                                        />
                                                                        <path
                                                                            d="M81.3271 148.596C81.3271 148.559 81.3271 148.522 81.3271 148.485C81.3395 148.485 81.3518 148.485 81.3642 148.485C81.3642 148.522 81.3642 148.559 81.3642 148.596C81.3518 148.596 81.3395 148.596 81.3271 148.596Z"
                                                                            fill="#564C93"
                                                                        />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#323B6E"
                                                                        />
                                                                        <path d="M45.9826 149.125H18.1289V149.68H45.9826V149.125Z" fill="#323B6E" />
                                                                        <path d="M219.522 149.162H59.6562V149.717H219.522V149.162Z" fill="#323B6E" />
                                                                        <path d="M59.6565 149.138H45.9827V149.692H59.6565V149.138Z" fill="#323B6E" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="white"
                                                                        />
                                                                        <path d="M59.2611 156.288L47.2656 156.308L47.2665 156.862L59.262 156.843L59.2611 156.288Z" fill="#323B6E" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#010101"
                                                                        />
                                                                        <path d="M175.686 152.342C175.785 152.391 175.884 152.453 175.995 152.514C175.785 152.699 175.736 152.49 175.686 152.342Z" fill="#010101" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#010101"
                                                                        />
                                                                        <path d="M177.686 152.933C177.636 153.155 177.451 153.007 177.34 153.044C177.389 152.822 177.575 152.983 177.686 152.933Z" fill="#010101" />
                                                                        <path d="M180.573 153.007C180.623 152.97 180.685 152.921 180.722 152.884C180.746 153.032 180.746 153.032 180.573 153.007Z" fill="#010101" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#010101"
                                                                        />
                                                                        <path d="M176.427 153.278C176.464 153.315 176.501 153.352 176.538 153.389C176.501 153.352 176.464 153.315 176.427 153.278Z" fill="#010101" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#CCCCCC"
                                                                        />
                                                                        <path d="M45.1803 148.115C45.2174 148.189 45.2544 148.25 45.2791 148.312C45.1927 148.324 45.0816 148.374 45.1803 148.115Z" fill="#CCCCCC" />
                                                                        <path d="M50.1044 152.243C50.1291 152.305 50.1537 152.379 50.1661 152.428C50.0797 152.465 50.0427 152.403 50.1044 152.243Z" fill="#CCCCCC" />
                                                                        <path d="M44.9089 145.576C44.8842 145.515 44.8472 145.453 44.8225 145.404C44.9212 145.354 44.9583 145.404 44.9089 145.576Z" fill="#CCCCCC" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#CCCCCC"
                                                                        />
                                                                        <path d="M55.1024 154.19C55.053 154.067 55.0283 154.005 55.0283 153.968C55.127 153.956 55.127 153.956 55.1024 154.19Z" fill="#CCCCCC" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#6576FF"
                                                                        />
                                                                        <path d="M173.529 54.5176C173.578 54.6038 173.628 54.6778 173.677 54.7517C173.529 54.7887 173.406 54.8257 173.529 54.5176Z" fill="#6576FF" />
                                                                        <path
                                                                            ...
                                                                            fill="#6576FF"
                                                                        />
                                                                        <path d="M178.552 67.8884C178.601 67.9254 178.675 67.9624 178.786 68.0363C178.515 68.061 178.515 68.061 178.552 67.8884Z" fill="#6576FF" />
                                                                        <path
                                                                        ...
                                                                        <path
                                                                            ...
                                                                            fill="#6576FF"
                                                                        />
                                                                        <path d="M172.456 59.1387C172.493 59.1018 172.53 59.0648 172.567 59.0278C172.53 59.0648 172.493 59.1018 172.456 59.1387Z" fill="#6576FF" />
                                                                    </g>
                                                                    <defs>
                                                            ...
                                                            <button class="btn btn-primary" style="margin: 20px" id="submit" type="submit">ثبت</button>
                                                        </div>
                                                    </div>
                                                    <ul class="nk-stepper-pagination pt-4 gx-4 gy-2 stepper-pagination">
                                                        <li class="step-prev"><button class="btn btn-dim btn-primary">قبلی</button></li>
                                                        <li class="step-next"><button class="btn btn-primary">بعدی</button></li>
                                                        <li class="step-submit"><button class="btn btn-primary d-none" id="submit">ارسال</button></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
